...
import net.polyv.android.player.common.ui.component.more.PLVMediaPlayerMoreActionLayoutLandscape
import net.polyv.android.player.common.ui.component.more.PLVMediaPlayerMoreSubtitleSettingLayoutLand
 ...
 * 横向-全屏 播放器皮肤 layout
 */
class PLVMediaPlayerFeedLandscapeItemLayout @JvmOverloads constructor(
    context: Context,
    ...
    private val audioModeCoverLandscape by lazy { findViewById<PLVMediaPlayerAudioModeCoverLayoutLandscape>(R.id.plv_media_player_audio_mode_cover_landscape) }
    ...
    // 当前视频尺寸
    protected var currentVideoSize: Rect? = null

    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Layout-方法-初始化 & 设置监听">
    init {
        LayoutInflater.from(context).inflate(R.layout.plv_media_player_feed_landscape_item_layout, this)
        setOnClickListener()
    }
    ...
    private fun setOnClickListener() {
        setOnClickListener(object : PLVOnDoubleClickListener() {
            override fun onSingleClick() {
                val dependScope = PLVMediaPlayerLocalProvider.localDependScope.on(this@PLVMediaPlayerFeedLandscapeItemLayout)
                    .current()
                    ?: return
