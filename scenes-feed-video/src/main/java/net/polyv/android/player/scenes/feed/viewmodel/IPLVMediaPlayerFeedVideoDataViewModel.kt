 ...
 * @author Hoshiiro
 */
interface IPLVMediaPlayerFeedVideoDataViewModel {
    /**
     * 获取更多视频数据
     *
     ...
     */
    fun requireMoreMediaResource(fromIndex: Int)

    fun getOnReceiveMediaResourceEvent(): MutableEvent<PLVStatefulData<List<PLVMediaResource>>>
}
