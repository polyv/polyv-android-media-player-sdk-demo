...
[![GitHub release](https://img.shields.io/badge/release-2.1.0-blue.svg)](https://github.com/polyv/polyv-android-media-player-sdk-demo/releases/tag/2.1.0)
...
### 3 文档
#### 3.1 接口文档
[v2.1.0 接口文档](https://repo.polyv.net/android/documents/media_player_sdk/2.1.0/index.html)
#### 3.2 版本更新记录
