 ...
 * 横向-全屏 播放器皮肤 layout
 */
public class PLVMediaPlayerSingleLandscapeItemLayout extends FrameLayout {

    // <editor-fold defaultstate="collapsed" desc="Layout-views">
    private ConstraintLayout videoLayout;
    private FrameLayout videoViewContainer;
    private PLVMediaPlayerAudioModeCoverLayoutLandscape audioModeCoverPortrait;
    ...
    public PLVMediaPlayerSingleLandscapeItemLayout(@NonNull Context context) {
        super(context);
    }

    public PLVMediaPlayerSingleLandscapeItemLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PLVMediaPlayerSingleLandscapeItemLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    {
        LayoutInflater.from(getContext()).inflate(R.layout.plv_media_player_single_landscape_item_layout, this);
        findViewById();
        setOnClickListener();
    }
    ...
    private void setOnClickListener() {
        setOnClickListener(new PLVOnDoubleClickListener() {
            ...
            protected void onSingleClick() {
                final DependScope dependScope = PLVMediaPlayerLocalProvider.localDependScope.on(PLVMediaPlayerSingleLandscapeItemLayout.this).current();
                if (dependScope == null) {
                    return;
                }
