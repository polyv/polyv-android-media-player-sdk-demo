 ...
 * @author Hoshiiro
 */
public class PLVMediaPlayerMoreSubtitleSettingLayoutLand extends FrameLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public PLVMediaPlayerMoreSubtitleSettingLayoutLand(@NonNull Context context) {
        super(context);
    }

    public PLVMediaPlayerMoreSubtitleSettingLayoutLand(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PLVMediaPlayerMoreSubtitleSettingLayoutLand(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    {
        LayoutInflater.from(getContext()).inflate(R.layout.plv_media_player_ui_component_more_subtitle_setting_layout_land, this);
    ...
    private class SubtitleItemLayout extends FrameLayout implements OnClickListener {
        ...
        private void initView() {
            LayoutInflater.from(getContext()).inflate(R.layout.plv_media_player_ui_component_more_subtitle_item_land, this);
