 ...
 * @author Hoshiiro
 */
public class PLVMediaPlayerNetworkPoorIndicateLayoutPortrait extends FrameLayout implements View.OnClickListener {
    ...
    public PLVMediaPlayerNetworkPoorIndicateLayoutPortrait(@NonNull Context context) {
        super(context);
    }

    public PLVMediaPlayerNetworkPoorIndicateLayoutPortrait(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PLVMediaPlayerNetworkPoorIndicateLayoutPortrait(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    {
        LayoutInflater.from(getContext()).inflate(R.layout.plv_media_player_ui_component_network_poor_indicate_layout_portrait, this);
    ...
    protected void onChangeBitRateSelectPanelVisible() {
        ...
        boolean isBitRateSelectPanelVisible = currentViewState.moreActionLayoutVisible;
