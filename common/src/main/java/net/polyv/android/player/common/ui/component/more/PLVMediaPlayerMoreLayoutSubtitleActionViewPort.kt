 ...
 * @author Hoshiiro
 */
class PLVMediaPlayerMoreLayoutSubtitleActionViewPort @JvmOverloads constructor(
    context: Context,
    ...
    init {
        LayoutInflater.from(context)
            .inflate(R.layout.plv_media_player_ui_component_more_subtitle_action_layout_port, this)
