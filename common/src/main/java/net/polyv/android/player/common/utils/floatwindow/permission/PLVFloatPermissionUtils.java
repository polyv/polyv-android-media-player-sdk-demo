package net.polyv.android.player.common.utils.floatwindow.permission;
...
import net.polyv.android.player.common.utils.floatwindow.permission.rom.HuaweiUtils;
import net.polyv.android.player.common.utils.floatwindow.permission.rom.MeizuUtils;
import net.polyv.android.player.common.utils.floatwindow.permission.rom.MiuiUtils;
import net.polyv.android.player.common.utils.floatwindow.permission.rom.OppoUtils;
import net.polyv.android.player.common.utils.floatwindow.permission.rom.QikuUtils;
import net.polyv.android.player.common.utils.floatwindow.permission.rom.RomUtils;
...
public class PLVFloatPermissionUtils {
    ...
    public static void requestPermission(Activity activity, IPLVOverlayPermissionListener listener) {
        if (checkPermission(activity) && listener != null) {
