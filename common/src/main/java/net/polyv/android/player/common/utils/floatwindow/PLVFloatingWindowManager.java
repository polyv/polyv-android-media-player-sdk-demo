package net.polyv.android.player.common.utils.floatwindow;
...
import net.polyv.android.player.common.utils.floatwindow.widget.IPLVFloatingLayout;
import net.polyv.android.player.common.utils.floatwindow.widget.PLVAbsFloatingLayout;
import net.polyv.android.player.common.utils.floatwindow.widget.PLVAppFloatingLayout;
import net.polyv.android.player.common.utils.floatwindow.widget.PLVSystemFloatingLayout;
...
public class PLVFloatingWindowManager implements IPLVFloatingLayout {
    ...
    public void setAutoEdgeMargin(int margin) {
        if (floatingLayout != null) {
            floatingLayout.setAutoEdgeMargin(margin);
        }
    }
    ...
    public static class WindowBuilder {
        ...
        public WindowBuilder setAutoEdgeMargin(int margin) {
            buildParam.autoEdgeMargin = margin;
            return this;
        }
        ...
        private static class Param {
            ...
            private PLVAbsFloatingLayout create() {
                ...
                floatingLayout.setShowType(showType);
                floatingLayout.setAutoMoveToEdge(autoEdgeType);
                floatingLayout.setAutoEdgeMargin(autoEdgeMargin);
                floatingLayout.setEnableDrag(enableDrag);
                floatingLayout.setConsumeTouchEventOnMove(consumeTouchEventOnMove);
