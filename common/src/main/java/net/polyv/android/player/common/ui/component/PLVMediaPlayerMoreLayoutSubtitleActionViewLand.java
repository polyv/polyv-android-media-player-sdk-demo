 ...
 * @author Hoshiiro
 */
public class PLVMediaPlayerMoreLayoutSubtitleActionViewLand extends FrameLayout implements View.OnClickListener {
    ...
    public PLVMediaPlayerMoreLayoutSubtitleActionViewLand(@NonNull Context context) {
        super(context);
        init();
    }

    public PLVMediaPlayerMoreLayoutSubtitleActionViewLand(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PLVMediaPlayerMoreLayoutSubtitleActionViewLand(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.plv_media_player_ui_component_more_subtitle_action_layout_land, this);
